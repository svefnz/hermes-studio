export default {
  ...
  sidebar: {
    ...
    connected: 'Verbunden',
    disconnected: 'Getrennt',
    updateTip: 'Fuhren Sie "hermes-studio update" im Terminal aus, um zu aktualisieren',
...
jobTriggered: 'Job ausgelost',
  ...
  usage: {
    ...
    agents: { hermes: 'Hermes Agent', claudeCode: 'Claude Code', codex: 'Codex', unknown: 'Unbekannt' },
